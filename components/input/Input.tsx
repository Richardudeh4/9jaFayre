...
const Input : React.FC<InputProps> = ({
  ...
  return (
    <div className='w-full relative '>
        ...
        type={type} className={`peer w-full p-4 pt-6 font-light bg-white border-2  rounded-[20px] outline-none transition disabled:opacity-70 disabled:cursor-not-allowed ${formatPrice ? 'pl-9': 'pl-4'}
